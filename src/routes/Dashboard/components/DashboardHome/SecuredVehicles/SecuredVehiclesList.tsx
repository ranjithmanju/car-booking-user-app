...
const SecuredVehiclesList: React.FC = () => {
    ...
    if (selectedVehicle) {
      navigate("/dashboard/secured-vehicles/capacity", {
        state: {
          ...
          vehicleData: selectedVehicle, // Pass the selected vehicle data
        },
      });
    }
  };
  ...
  const availableVehicles = vehicles.slice(0, 2);
  const unavailableVehicles = vehicles.slice(2);
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    {vehicle.name === "Bharat Benz Truck" ? (
                      <div className="flex items-center text-fact meet-greeting">
                        ...
                        <span>2 Security drivers</span>
                      </div>
                    ) : (
                      <div className="flex items-center text-fact meet-greeting">
                        <ShieldCheck className="w-5 h-5 mr-2" />
                        <span>1 Security Escort</span>
                      </div>
                    )}
                    <div className="flex items-center">
...
export default SecuredVehiclesList;
